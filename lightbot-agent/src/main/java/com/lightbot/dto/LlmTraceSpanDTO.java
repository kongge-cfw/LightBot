...
public class LlmTraceSpanDTO {
     ...
     * @return LlmTraceSpanDTO 实例
     */
    public static LlmTraceSpanDTO of(String spanId, String parentSpanId, String name,
                                   long startTime, long durationMs, String status,
                                   Map<String, Object> attributes) {
        LlmTraceSpanDTO span = new LlmTraceSpanDTO();

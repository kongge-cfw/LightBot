...
.event-done { border: 1px solid #dcfce7; }
.event-fail { border: 1px solid var(--color-error-soft); background: var(--color-error-bg); }
.event-suspended { border: 1px solid #fed7aa; background: #fff7ed; }
...
.event-icon.icon-suspended { color: #f97316; }
...
.event-head:hover { background: var(--color-purple-bg); }
...
.event-summary { font-size: 11px; color: #7c3aed; max-width: 200px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
